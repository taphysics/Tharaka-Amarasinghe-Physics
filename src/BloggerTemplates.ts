...
<body>
  ...
  <div id='app'>
    ...
    <header class='topbar'>
      <div class='brand'>
        <div class='brand-logo-circle'>Ω</div>
        <div>
        ...
        <div class='hero'>
          ...
          <div class='hero-panel'>
            ...
            <div class='teacher-portrait-area'>
              <!-- Professional looking abstract placeholder portrait -->
              <div style='background-color:#1e293b; border-radius:50%; width:100%; height:100%; display:flex; align-items:center; justify-content:center; font-family:"Space Grotesk", sans-serif; font-size:3rem; font-weight:700; color:var(--primary); box-shadow:0 0 10px rgba(0,0,0,0.5);'>TA</div>
            </div>
            <div class='teacher-name'>Taraka Amarasinghe</div>
            <div class='teacher-title'>B.Sc. Hon. USJP | Physics Tutor</div>
    ...
    <footer>
      <div class='footer-nav'>
        ...
        <a class='footer-link' onclick='openPublicAlertsModal()'>Public Alert!</a>
      </div>
